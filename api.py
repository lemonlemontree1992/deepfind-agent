...
ALLOWED_ORIGINS = os.getenv("ALLOWED_ORIGINS", "http://localhost:3000,http://127.0.0.1:3000,https://deepfind-agent.vercel.app,https://lemonlemonaiproject.netlify.app").split(",")
